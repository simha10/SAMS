...
const { generateReport, previewReport, getMyReports, downloadReport, deleteReport, streamReport } = require('../controllers/reportController');
const { protect, restrictTo } = require('../middleware/auth');

// Report routes
router.post('/', protect, generateReport);
router.post('/preview', protect, previewReport);
router.post('/stream', protect, streamReport);
